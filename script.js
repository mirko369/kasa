const drinks = {
  ...
  coldDrinks: {
    ...
    price: ["6,00 Є","5,00 Є", "5,50 Є", "7,00 Є", "9,00 Є", "11,00 Є"],
  },
  sweets: {
...
{
  inventura.push("Paper Plane");
  inventura.push(0);
  inventura.push("Bebbo");
  inventura.push(0);
  inventura.push("Zec Scn");
  inventura.push(0);
  inventura.push("Hydra");
  inventura.push(0);
  inventura.push("Matcha latte");
  inventura.push(0);
  inventura.push("Iced Matcha latte");
  inventura.push(0);
  inventura.push("Old Pilots London Dry");
  inventura.push(0);
  ...
  dnevna.push("Hydra");
  dnevna.push(0);
  dnevna.push("Matcha latte");
  dnevna.push(0);
  dnevna.push("Iced Matcha latte");
  dnevna.push(0);
  dnevna.push("Old Pilots London Dry");
  dnevna.push(0);
